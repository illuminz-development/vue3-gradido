Important step to setup Gradido

after cloning the set up from Git
1) First run the command "npm install"
2) After installing all modules just run command "npm run serve"

it will start gradido on your local server
