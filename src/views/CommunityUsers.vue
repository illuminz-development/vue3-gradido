                            ...
                            <table class="table align-items-center justify-content-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Community's user UUID
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr v-else-if="list.length > 0" v-for="item in list" :key="item">
                                        ...
                                        <td>
                                            <div class="d-flex px-2">
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">{{ item.userUuid }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">{{ item.UserProfile.firstName }} {{ item.UserProfile.lastName }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-xs">{{
                                                item.Communities?.[0]?.name }}</span>
                                        </td>
                                        <td>
                                            <span class="text-xs">{{
                                                item.UserProfile?.movement }}</span>
                                        </td>
                                        <td>
